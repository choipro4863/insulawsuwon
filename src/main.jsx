  ...
  return (
    <div className="app">
      ...
      <aside className="side-menu">
        ...
        <button>DB관리 시스템</button>
        <button>심질병력분석</button>
        <button>보장분석</button>
        <button>전산 바로가기</button>
        <button>KCD 질병코드</button>
        <button>실손 계산기</button>
        <button>1~5종 수술비</button>
        <button>1~7종 수술비</button>
        <button>1~8종 수술비</button>
